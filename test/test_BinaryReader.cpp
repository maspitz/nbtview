...
TEST_CASE("nbtview::detail::BinaryReader Floating Point Types") {
    ...
    auto s32 = nbtview::BinaryReader(v32);
    ...
    auto v64 = std::vector<unsigned char>{0x3f, 0xc9, 0x99, 0x99,
                                          0x99, 0x99, 0x99, 0x9a};
    auto s64 = nbtview::BinaryReader(v64);
...
TEST_CASE("nbtview::BinaryReader String") {
    ...
    nbtview::BinaryReader scanner3(data3);
...
TEST_CASE("nbtview::BinaryReader Vector") {
    ...
    std::vector<unsigned char> data4 = {0x00, 0x00, 0x00, 0x02,
                                        0x01, 0x02, 0x03};
    nbtview::BinaryReader scanner4(data4);
